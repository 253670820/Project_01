...
namespace MvcWeb.MultipartRequest
{
    public static class FileStreamingHelper
    {
        private static readonly FormOptions _defaultFormOptions = new FormOptions();

        public static async Task<MyFormValueProvider> StreamFiles(this HttpRequest request, string targetDirectory)
        {
            string fileName = "";
            ...
            var formValueProvider = new MyFormValueProvider(
                BindingSource.Form,
                new FormCollection(formAccumulator.GetResults()),
                CultureInfo.CurrentCulture);

            formValueProvider.FileName = fileName;
